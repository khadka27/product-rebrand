...
export default function PricingCardIcon({
  title,
  subtitle,
  price,
  originalPrice,
    ...
    >
      ...
      <div className="p-8 md:p-10 text-center">
        ...
        <div className="flex justify-center mb-8">
          {/* Approach 3: Simplified icon representation */}
          <div className="w-full max-w-[280px] mx-auto">
            <div className="bg-red-50 rounded-xl p-8 border border-red-100">
              <div className="flex justify-center mb-4">
                <div className="relative w-32 h-32">
                  <Image src="/hepatoburn-bottle.png" alt="HepatoBurn Bottle" fill className="object-contain" />
                </div>
              </div>

              <div className="flex items-center justify-center gap-2 bg-red-900 text-white py-3 px-6 rounded-lg">
                <span className="text-3xl font-bold">{bottleCount}x</span>
                <span className="text-xl font-semibold">Bottles</span>
              </div>

              <div className="mt-4 text-red-800 font-semibold">
                {bottleCount === 2 && "2 Month Supply"}
                {bottleCount === 3 && "3 Month Supply"}
                {bottleCount === 6 && "6 Month Supply"}
              </div>
            </div>
          </div>
        </div>
